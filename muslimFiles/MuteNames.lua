...
if DevAbs:get(muslim.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(muslim.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(muslim.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومة" and Constructor(msg) then
DevAbs:del(muslim.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومة")
end
if text == "الاسماء المكتومة" and Constructor(msg) then
local AllNames = DevAbs:smembers(muslim.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(muslim.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
muslimName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if muslimName then 
muslimNames = DevAbs:smembers(muslim.."Abs:Mute:Names"..msg.chat_id_) or ""
if muslimNames and muslimNames[1] then 
for i=1,#muslimNames do 
if muslimName:match("(.*)("..muslimNames[i]..")(.*)") then 
...
DevAbs:set(muslim.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(muslim.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
